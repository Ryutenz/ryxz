...
conn.sendMessage(`6283819082780@s.whatsapp.net`, { text: `[ REPORT ]\n\nDari: wa.me/${m.sender.split('@')[0]}\nPesan: ${text}`}, {quoted: m})
...
└───────────┈ ⳹`
	 let buttons = [
        { buttonId: `${prefix}owner`, buttonText: { displayText: `OWNER RYZBOT` }, type: 1 }
        ]
        let buttonMessage = {
...
│✙ 𝗢𝘄𝗻𝗲𝗿 𝗡𝗮𝗺𝗲 : Unknown
│✙ 𝗢𝘄𝗻𝗲𝗿 𝗡𝘂𝗺𝗯𝗲𝗿 : wa.me/6283819082780
...
└┬──────────┈ ⳹
    ...
    └───────────┈ ⳹`,
          ...
          m.reply (`Ini adalah nomor WhatsApp Owner Ryzbot
...
𝗢𝗥𝗗𝗘𝗥 𝗦𝗘𝗞𝗔𝗥𝗔𝗡𝗚 𝗛𝗨𝗕𝗨𝗡𝗚𝗜 𝗢𝗪𝗡𝗘𝗥 𝗕𝗢𝗧 https://wa.me/6283819082780?text=Sewa
`)
break
  case 'tqto':
  reply(`┏━━⬣ 𝐓𝐇𝐀𝐍𝐊𝐒 𝐓𝐎 
...
} else if (nomore3.includes('6283819082780')) { throw `*ITU NOMOR OWNER BOT 😡😈🖕*`
} else if (nomore3.includes('6283819082780')) { throw `*ITU NOMOR OWNER BOT 😡😈🖕*`
} else if (nomore3.includes('6283819082780')) { throw `*ITU NOMOR OWNER BOT 😡😈🖕*`
} else if (nomore3.includes('6283819082780')) { throw `*ITU NOMOR OWNER BOT 😡😈🖕*`
} else if (nomore3.includes('6283819082780')) { throw `*ITU NOMOR OWNER BOT 😡😈🖕*`
